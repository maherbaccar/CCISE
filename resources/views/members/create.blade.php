...
<div class="card" style="margin:20px;">
    ...
    <div class="card-body">
        <form action="{{url('members')}}" method="post" enctype="multipart/form-data">
            ...
            <input type="number" name="n_patente" id="n_patente" class="form-control"><br/>
            <label>Raison Sociale</label><br/>
            <input type="text" name="raison_social" id="raison_social" class="form-control"><br/>
            ...
            <input type="tel" name="tel" id="tel" class="form-control"><br/>
            <label>Fax</label><br/>
            <input type="tel" name="fax" id="fax" class="form-control"><br/>
            <label>Email</label><br/>
            <input type="email" name="email" id="email" class="form-control"><br/>
            <label>Site Web</label><br/>
            <input type="url" name="site_web" id="site_web" class="form-control"><br/>
            <label>Adresse</label><br/>
            <input type="text" name="adresse" id="adresse" class="form-control"><br/>
            <label>Secteur</label><br/>
            <input type="text" name="secteur" id="secteur" class="form-control"><br/>
            <label>Sous Secteur</label><br/>
            <input type="text" name="sous_secteur" id="sous_secteur" class="form-control"><br/>
            <label>Produits</label><br/>
            <input type="text" name="pdts" id="pdts" class="form-control"><br/>
            <label>N°Carte Adhérent</label><br/>
            <input type="number" name="n_carte_adhérent" id="n_carte_adhérent" class="form-control"><br/>
            <label>Pack</label><br/>
